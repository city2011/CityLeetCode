...
############################################# 题目描述 #############################################
 */
public class L174DungeonGame {
    public static void main(String[] args) {
        L174DungeonGame m = new L174DungeonGame();
        int [][] dungeon = new int [][] {{-2,-3,3},{-5,-10,1},{10,30,5}};

        int rest = m.calculateMinimumHP(dungeon);
    ...
    private int calculateMinimumHP(int[][] dungeon) {
        ...
        Arrays.stream(dungeon).forEach(x -> System.out.println(Arrays.toString(x)));
        System.out.println();
